...
(
    ...
    CONSTRAINT CHK_OUTBOX_PAYLOAD_JSON CHECK (PAYLOAD IS JSON FORMAT JSON),
    CONSTRAINT CHK_OUTBOX_HEADERS_JSON CHECK (HEADERS IS JSON FORMAT JSON)
);
...
(
    ...
    CONSTRAINT CHK_ERR_PAYLOAD_JSON CHECK (PAYLOAD IS JSON FORMAT JSON)
);
