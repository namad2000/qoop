...
@ContextConfiguration(classes = {
        ...
        TestGlobalDlq.class    // Adding the DLQ consumer
})
public class KafkaIntegrationGlobalDlqWithoutContainerTest {

    @Autowired
    private KafkaTemplate<String, Object> kafkaTemplate;

    @Autowired
    private TestGlobalDlq testGlobalDlq; // Injected to access the DLQ queue
    ...
    void testRetryAndDlqWithConfiguredConsumer() {
        ...
        await().atMost(15, TimeUnit.SECONDS)
                .until(() -> !testGlobalDlq.dlqQueue.isEmpty() || !testConsumer.mainQueue.isEmpty());

        if (!testGlobalDlq.dlqQueue.isEmpty()) {
            ...
            System.out.println("✅ Test Passed: Message successfully sent to GLOBAL DLQ.");
